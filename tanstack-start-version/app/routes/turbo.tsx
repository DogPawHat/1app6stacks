...
import { getTurboRandomNumberQueryOptions } from "~/utils/get-random-number";
...
function TurboVoteContent() {
  const { data: pokemonSeed } = useSuspenseQuery(getTurboRandomNumberQueryOptions());
...
function TurboVoteComponent({ children }: { children: React.ReactNode }) {
  return (
    <div className="flex justify-center gap-16 items-center min-h-[80vh]">
